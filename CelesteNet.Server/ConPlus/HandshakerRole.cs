...
namespace Celeste.Mod.CelesteNet.Server {
    ...
    */
    public partial class HandshakerRole : NetPlusThreadRole {
        ...
        public async Task DoTCPUDPHandshake(Socket sock, Action<CelesteNetSendQueue> tcpQueueFlusher, Action<CelesteNetSendQueue> udpQueueFlusher) {
            ...
            try {
                ...
                Server.HandleConnect(con = new CelesteNetTCPUDPConnection(Server.Data, sock, conUID, Server.Settings.MergeWindow, tcpQueueFlusher, udpQueueFlusher));
